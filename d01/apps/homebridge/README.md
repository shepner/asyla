...
- **URLs:** `https://homebridge.asyla.org` (Homebridge UI, port 8581), `https://cameraui.asyla.org` (Camera UI, port 8181).
...
Ports on the host: 8581 (Homebridge UI → homebridge.asyla.org), 8181 (Camera UI → cameraui.asyla.org), 51956 (Homebridge HAP service).
