...
# Run once initiator is in TrueNAS Initiator Group: ~/setup_manual.sh  (or sudo ~/scripts/d01/setup/setup_iscsi_connect.sh)
...
echo "This host's initiator (must be in TrueNAS Initiator Group for target nas01:d01:01):"
