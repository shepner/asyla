...
NAME_OF_TARGET="iqn.2005-10.org.freenas.ctl:data1:plex:01"  # update as appropriate
...
doas mkdir -p /mnt/nas/data1/plex_01
echo "/dev/sdb1 /mnt/nas/data1/plex_01 ext4 _netdev,rw 0 0" | doas tee -a /etc/fstab
doas mount -a
