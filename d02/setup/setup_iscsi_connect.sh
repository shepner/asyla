...
# Run once initiator is in TrueNAS Initiator Group: ~/setup_manual.sh  (or sudo ~/scripts/d02/setup/setup_iscsi_connect.sh)
...
NAME_OF_TARGET="iqn.2005-10.org.freenas.ctl:nas01:d02:01"

echo "This host's initiator (must be in TrueNAS Initiator Group for target nas01:d02:01):"
