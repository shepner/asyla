...
echo "     scp ~/.ssh/docker_rsa d03:.ssh/docker_rsa"
echo "     scp ~/.ssh/docker_rsa.pub d03:.ssh/docker_rsa.pub"
echo "     scp ~/.ssh/config d03:.ssh/config"
echo "     ssh d03 'chmod 600 ~/.ssh/docker_rsa ~/.ssh/config && chmod 644 ~/.ssh/docker_rsa.pub && chmod 700 ~/.ssh'"
echo "  4. Run SSH setup script: ssh d03 '~/scripts/d03/setup/setup_ssh_keys.sh'"
echo "  5. Add d03's public key to d01 and d02 (for app migration):"
echo "     ssh d03 'cat ~/.ssh/docker_rsa.pub' | ssh d01 'cat >> /home/docker/.ssh/authorized_keys && chmod 600 /home/docker/.ssh/authorized_keys'"
echo "     ssh d03 'cat ~/.ssh/docker_rsa.pub' | ssh d02 'cat >> /home/docker/.ssh/authorized_keys && chmod 600 /home/docker/.ssh/authorized_keys'"
echo "  6. Test docker-to-docker SSH: ssh d03 'ssh docker@d01 echo test'"
...
log_info "      See d03/README.md for detailed instructions."
