...
- `apps/pihole/` – **symlink** into **`~/local/asyla/projects/pihole/hosts/ns01`**. Canonical git: **https://gitlab.com/asyla/pihole** (edit there; pull on VMs per [pihole `hosts/DEPLOY-VM.md`](../../../../asyla/projects/pihole/hosts/DEPLOY-VM.md)).
