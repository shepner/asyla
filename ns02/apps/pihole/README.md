...
**Canonical repo:** [gitlab.com/asyla/pihole](https://gitlab.com/asyla/pihole) — this directory is `hosts/ns02/` in that repo. On **ns02**, install these files as a **real directory** at `~/scripts/ns02/apps/pihole/` (rsync from a clone or from your workstation); see [`hosts/DEPLOY-VM.md` in the Pi-hole repo](https://gitlab.com/asyla/pihole/-/blob/main/hosts/DEPLOY-VM.md).
...
```bash
./pihole.sh up
# or: ~/scripts/ns02/apps/pihole/pihole.sh up
```
